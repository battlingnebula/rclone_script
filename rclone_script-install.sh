...
# global variables
url="https://raw.githubusercontent.com/battlingnebula/rclone_script"
branch="master"
...
backtitle="RCLONE_SCRIPT installer (https://github.com/battlingnebula/rclone_script)"
...
function 2cCompilePNGVIEW ()
{
	...
	{ #try
		# compile
		# cd ~/raspidmx-master &&
		sudo make --directory=~/raspidmx-master &&
